...
import GetLinkForm from "@/components/interface-links/get-link-form";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "GetPage" });
...
const GetPage = async () => {
  const t = await getTranslations("GetPage");
